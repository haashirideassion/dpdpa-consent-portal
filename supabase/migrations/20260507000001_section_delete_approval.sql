-- ============================================================
-- 20260507000001_section_delete_approval.sql
-- Adds __section_delete__ branch to approve_correction RPC.
--
-- When an employee submits a delete request for a multi-entry
-- record, admin approval now executes a DELETE on the target
-- table WHERE id = recordId AND employee_id = employee_id.
-- ============================================================
...
DECLARE
  ...
  -- Whitelisted tables for multi-entry section corrections (INSERT / UPDATE / DELETE WHERE id)
